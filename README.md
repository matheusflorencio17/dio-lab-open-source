...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/SEU_USERNAME`;
    ...
    > Deste modo será criada uma ramificação para que possa ser feita sua atualização e para que possa desta forma identificar para que seja feito processo de forma segura;
